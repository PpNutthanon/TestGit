#Precision Recall & F1-Score => ค่ามากกว่า 90% คือโมเดลมีประสิทธิภาพ
#คำสั่งที่ใช้คือ => from sklearn.metrics import Classification_report
#? Precision = True Positives / (True Positives + False Positives)
#? Recall = True Positives / (True Positives + False Negatives)
#? F1 = (2 * Precision * Recall) / (Precision + Recall)
#*Todo True Positives => ทายว่าถูก แล้วคำตอบตรงกับที่ทาย
#*Todo True Negatives => ทายว่าไม่ถูก แล้วคำตอบตอบตรงกับที่ทาย
#*Todo False Positives => ทายว่าถูก แต่คำตอบคือไม่ถูก
#*Todo False Negatives => ทายว่าไม่ถูก แต่คำตอบคือไม่ถูก
...
y_test_pred = sgd_cls.predict(x_test)
classes = ["other number","Number 5"]
